                    ...
                    <FormField
                        ...
                        render={({ field:{value, ...fieldValues} }) => (
                            <FormItem>
                                ...
                                <FormControl>
                                    <Input {...fieldValues} type="file" accept="image/*" onChange={(e: React.ChangeEvent<HTMLInputElement>) => {const file = e.target.files?.[0]; fieldValues.onChange(file)} } ref={photoInputRef}/>
