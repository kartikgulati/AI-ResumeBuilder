...
import { GenerateWorkExperienceInput, generateWorkExperienceSchema, WorkExperience } from "@/lib/validaton";
    ...
    async function onSubmit(input: GenerateWorkExperienceInput) {
         try {
            ...
            return <Dialog open={open} onOpenChange={onOpenChange}>
                ...
                <DialogDescription>
                    AI generated work experience fpr you resume.
                </DialogDescription>
                </DialogHeader>
                <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-3">
                    ...
                    render={({ field }) => (
                        ...
                        <FormControl>
                            <Textarea 
                            {...field}
                             placeholder= {`eg. "Form jan 2024 to aug 2025 I worked in KG tech as a Web developer"`} {...field} autoFocus />
                        </FormControl>
                        <FormMessage />
                        </FormItem>
                    )}
